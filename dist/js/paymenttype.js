...
async function handleSubmit(e) {
 ...
 function handleRouting(radio) {
    if(radio.revolut && radio.amazon) {
        sessionStorage.setItem("userRoute", JSON.stringify(["http://127.0.0.1:5500/pages/Userform/amazonqr.html"]));
        window.location.href = "http://127.0.0.1:5500/pages/Userform/revolutqr.html";  // First Route
    }
    else if(radio.revolut){
        window.location.href = "http://127.0.0.1:5500/pages/Userform/revolutqr.html";
    }
   else {
    window.location.href = "http://127.0.0.1:5500/pages/Userform/amazonqr.html";
   }
 }
